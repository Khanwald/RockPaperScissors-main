 ...
 */
func determineWinner(_ user:String, _ pc:String)->String{
    var descion = "It's a tie"
    switch user{
    case "rock":
        switch pc{
        case "rock": descion = "It's a tie"
        case "paper": descion = "The computer won"
        case "scissors": descion = "The user won"
        default: ""
        }
    case "paper":
        switch pc{
        case "rock": descion = "The user won"
        case "paper": descion = "It's a tie"
        case "scissors": descion = "The computer won"
        default: ""
        }
    case "scissors":
        switch pc{
        case "rock": descion = "The computer won"
        case "paper": descion = "The user won"
        case "scissors": descion = "It's a tie"
        default: ""
        }
    default: ""
    }
...
*/
for _:Int in 1...4{
    let userCall = getUserChoice("paper")
    let pcCall = getComputerChoice()

    print("You threw \(userCall)")
    print("The computer threw \(pcCall)")

    print(determineWinner(userCall, pcCall))
    print("")
}
